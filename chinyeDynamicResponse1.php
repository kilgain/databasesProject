...
echo " <p style=\"text-align:center\"> Common Name " . $speciesName . " present: </p>";


         $candy_query = mysqli_query($conn, "SELECT commonName FROM species WHERE speciesName=\"{$speciesName}\"");
